...
using mostlylucid.activetranslatetag.Services.InMemory;
using Xunit;
...
public class ServiceCollectionExtensionsTests
{
    ...
    public void AddAutoTranslateFromConfiguration_WithChunking_RegistersChunkingProvider()
    {
        ...
        var aiProvider = provider.GetService<IAiTranslationProvider>();
        aiProvider.Should().NotBeNull();
        aiProvider.Should().BeOfType<mostlylucid.activetranslatetag.Services.Providers.ChunkingAiTranslationProvider>();
    }
