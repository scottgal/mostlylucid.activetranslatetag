...
public class ChunkingAiTranslationProviderTests
{
    ...
    public async Task TranslateAsync_ShortText_CallsInnerProviderDirectly()
    {
        ...
        mockInner.Setup(x => x.TranslateAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((string text, string target, string? source, string? description, CancellationToken ct) => $"{text}_translated");
        ...
        mockInner.Verify(x => x.TranslateAsync(shortText, "fr", "en", It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task TranslateAsync_LongText_SplitsIntoChunks()
    {
        ...
        var callCount = 0;
        mockInner.Setup(x => x.TranslateAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((string text, string target, string? source, string? description, CancellationToken ct) =>
            {
                callCount++;
        ...
        mockInner.Verify(x => x.TranslateAsync(It.IsAny<string>(), "fr", "en", It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.AtLeast(2));
    }
    ...
    public async Task TranslateAsync_EmptyText_ReturnsEmpty()
    {
        ...
        // Assert
        result.Should().Be("");
        mockInner.Verify(x => x.TranslateAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task TranslateBatchAsync_MixedSizes_SeparatesSmallAndLarge()
    {
        // Arrange
        var mockInner = new Mock<IAiTranslationProvider>();
        mockInner.Setup(x => x.TranslateBatchAsync(It.IsAny<Dictionary<string, string>>(), It.IsAny<string>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((Dictionary<string, string> items, string target, string? source, string? description, CancellationToken ct) =>
                items.ToDictionary(kv => kv.Key, kv => $"{kv.Value}_batch_translated"));

        mockInner.Setup(x => x.TranslateAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((string text, string target, string? source, string? description, CancellationToken ct) => $"{text}_individual_translated");
        ...
        mockInner.Verify(x => x.TranslateBatchAsync(
            ...
            "fr", "en", It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task TranslateBatchAsync_AllSmallItems_UsesBatchOnly()
    {
        ...
        // Assert
        result.Should().HaveCount(3);
        mockInner.Verify(x => x.TranslateBatchAsync(It.IsAny<Dictionary<string, string>>(), "fr", "en", It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.Once);
        mockInner.Verify(x => x.TranslateAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task TranslateAsync_TextExactlyAtChunkLength_NoChunking()
    {
        ...
        mockInner.Verify(x => x.TranslateAsync(text, "fr", "en", It.IsAny<string?>(), It.IsAny<CancellationToken>()), Times.Once);
    }
