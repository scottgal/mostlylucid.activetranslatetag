...
public interface IAiTranslationProvider
{
    ...
    /// <param name="description">Optional context description to improve translation quality (used by LLM providers only).
    /// Example: "A marketing slogan for a tech startup" or "Error message shown when login fails"</param>
    ...
    /// <param name="description">Optional context description to improve translation quality (used by LLM providers only).
    /// When provided, it applies as general context to all items in the batch.</param>
    /// <param name="ct">Cancellation token</param>
